...
import com.gempukku.tcg.generic.events.SendDecisionEvent;
        ...
        action.insertEvent(
                new ChooseRandomEvent(players) {
                    ...
                    protected void valueChosen(final String value, EventAction action, ActionStack actionStack, final GameState gameState, DecisionCallback decisionCallback) {
                        ...
                        action.insertEvent(new SendSystemMessageEvent(MtgConstants.MESSAGE_DISPLAY, "Player " + value + " has won the roll"));
                    }
                });
    }
}
